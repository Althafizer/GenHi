    ...
    <section id="artikel" className="bg-white py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex justify-between items-end mb-10 flex-wrap gap-4">
          ...
          <Link href="/artikel" className="border-2 border-green-600 text-green-600 px-5 py-2.5 rounded-xl text-sm font-bold hover:bg-green-50 transition-colors">
            Lihat Semua →
          </Link>
        </div>
            ...
            <div key={a.id} className="bg-white border border-green-50 rounded-2xl overflow-hidden hover:shadow-xl hover:shadow-green-900/8 hover:-translate-y-1 transition-all duration-300 cursor-pointer">
              ...
              <div className="p-5">
                <div className="flex justify-between mb-3">
                  ...
                  <span className="text-gray-400 text-xs">📖 {a.read_time} menit</span>
                </div>
